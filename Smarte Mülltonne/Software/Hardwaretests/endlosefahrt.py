...
class DualStepper:
    ...
    def move_together(self, left_dir, right_dir, schritte=None):
...
#
 #           sleep_us(self.delay_us)
    ...
    def geradeaus_fahrt(self, schritte):
        self.move_together( 1, 1, schritte)

    def rueckwaerts_fahrt(self, schritte):
        self.move_together( 0, 0, schritte)

    def drehung_links(self, schritte):
        self.move_together( 0, 1, schritte)

    def drehung_rechts(self, schritte):
        self.move_together( 1, 0, schritte)
    ...
    def stop(self):
        self.left_enable.value(1)
        self.right_enable.value(1)
