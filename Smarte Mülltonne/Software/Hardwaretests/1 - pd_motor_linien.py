...
# ---------------- MOTOREN ----------------
# Belegung nach Verpol-Blast + Treibertausch (2026-07-11), identisch zur am
# realen Aufbau per Fahrtest verifizierten Zuordnung in Quellcode/Client/main.py:
#   LINKS  an 13/8/9   (vorwaerts = DIR 0)
#   RECHTS an 10/11/12 (vorwaerts = DIR 1)
# ACHTUNG: Vertauschte L/R-Labels fallen bei Geradeausfahrt NICHT auf, erst die
# PD-Korrektur lenkt dann spiegelverkehrt. Nicht nach Gefuehl tauschen, sondern
# per Einzelmotor-Test verifizieren.
LEFT_DIR_PIN = 13
LEFT_STEP_PIN = 8
LEFT_ENABLE_PIN = 9
...
print("Motor links:  DIR GP13, STEP GP8,  ENABLE GP9")
print("Motor rechts: DIR GP10, STEP GP11, ENABLE GP12")
