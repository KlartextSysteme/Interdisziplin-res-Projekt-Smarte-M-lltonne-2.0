...
class TouchUi:
    ...
    def draw_status(self):
        self.buttons = [
            ...
            Button(256, 0, 64, 64, "pin"),
            Button(0, 176, 64, 64, "pin"),
            Button(0, 0, 64, 64, "pin"),
        ]
        ...
        self.r.draw(asset)
        if asset in ("status_full_home_clean", "status_full_truck_clean"):
    ...
    def draw_menu(self, page):
        ...
        positions = ((28, 36), (178, 36), (28, 126), (178, 126))
    ...
    def draw_submenu(self):
        ...
        for i, (_label, action) in enumerate(defs):
            self.buttons.append(Button(50 + i * 140, 52, 100, 78, "do:" + action))
