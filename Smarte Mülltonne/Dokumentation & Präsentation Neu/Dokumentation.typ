...
Die Weiterentwicklung der Smarten Mülltonne erfolgte auf zwei miteinander verbundenen Ebenen. Die erste und zentrale Ebene bildete der physische Prototyp. Antrieb, Schrittmotoren, Räder, Ketten, Fahrwerk, Sensorik, Energieversorgung und Sicherheitsfunktionen wurden überarbeitet und schrittweise integriert. Ziel war es, eine Mülltonne zu entwickeln, die kontrolliert, zuverlässig und wiederholbar fahren sowie auf unterschiedliche Betriebs- und Sicherheitszustände reagieren kann. Dieser Bereich bildete die technische Grundlage der gesamten Projektarbeit.

Die zweite Ebene umfasste die digitalen Bedienungs- und Managementsysteme. Das Touchpanel wurde als lokale Benutzerschnittstelle für die direkte Interaktion mit einer einzelnen Mülltonne konzipiert. Es ermöglicht den Zugriff auf Fahr-, Status-, Sicherheits- und Diagnosefunktionen. Ergänzend dazu wurde die Flottenmanagement-Web-App `smart-bin` für die zentrale Überwachung und Steuerung mehrerer Mülltonnen entwickelt. Sie stellt Mülltonnen auf einer Karte dar, verarbeitet Live-Daten, unterstützt die Abholplanung anhand des Füllstands, visualisiert Energie- und Sicherheitsinformationen und bietet Simulations- sowie Assistenzfunktionen.

Touchpanel und Web-App wurden als ergänzende Bedienebenen eines gemeinsamen Systems betrachtet. Während das Touchpanel die lokale Interaktion ermöglicht, übernimmt die Web-App die übergeordnete Verwaltung und Überwachung. Beide digitalen Komponenten sind mit den Zuständen und Funktionen des physischen Prototyps verbunden und machen das Zusammenspiel von Hardware, Software und Nutzerinteraktion sichtbar.

Die Vorarbeiten aus dem Wintersemester dienten weiterhin als technischer Ausgangspunkt, wurden jedoch nicht als eigene Projektleistung bewertet. Die Arbeit im aktuellen Projekt bestand darin, den vorhandenen Einzelprototyp technisch weiterzuentwickeln, um lokale und zentrale Bedienmöglichkeiten zu ergänzen und die einzelnen Komponenten zu einem dokumentierten Gesamtsystem der Smarten Mülltonne 2.0 zusammenzuführen.